		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Auf&#x27;s Portofolio",
									"targetURL": "#aaufaraufportofolioproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aaufaraufportofolioproject-display": {
								"semanticObject": "aaufaraufportofolioproject",
								"action": "display",
								"description": "Portofolio of Aditya Aufar",
								"title": "Auf&#x27;s Portofolio",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aaufar.aufportofolioproject",
									"url": sap.ui.require.toUrl("aaufar/aufportofolioproject")
								}
							}
						}
					}
